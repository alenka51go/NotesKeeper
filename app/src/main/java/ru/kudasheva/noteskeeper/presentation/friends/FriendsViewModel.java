...
public class FriendsViewModel extends ViewModel {
    ...
    public MutableLiveData<List<FriendCard>> friendList = new MutableLiveData<>();
    ...
    private List<FriendCard> convertToFriendsInfoCard(List<User> friends) {
        List<FriendCard> friendCards = new ArrayList<>();
        for (User friend : friends) {
            friendCards.add(friend.createFriendInfoCard());
        }
        return friendCards;
    }
}
